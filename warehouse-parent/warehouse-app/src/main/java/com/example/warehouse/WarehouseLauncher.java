...
public class WarehouseLauncher extends Launcher {

  private static final Logger log = LoggerFactory.getLogger(WarehouseLauncher.class);
  ...
  public static void main(String[] args) {
    ...
    new WarehouseLauncher().dispatch(args);
  }
