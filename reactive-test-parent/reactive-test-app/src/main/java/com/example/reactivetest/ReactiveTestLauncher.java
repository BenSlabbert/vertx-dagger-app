...
public class ReactiveTestLauncher extends Launcher {

  private static final Logger log = LoggerFactory.getLogger(ReactiveTestLauncher.class);

  public static void main(String[] args) {
    new ReactiveTestLauncher().dispatch(args);
  }
