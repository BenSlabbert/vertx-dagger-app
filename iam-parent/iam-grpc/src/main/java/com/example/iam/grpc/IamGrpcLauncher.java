...
public class IamGrpcLauncher extends Launcher {

  private static final Logger log = LoggerFactory.getLogger(IamGrpcLauncher.class);

  public static void main(String[] args) {
    new IamGrpcLauncher().dispatch(args);
  }
  ...
  public void afterConfigParsed(JsonObject config) {
    ...
    try (var input =
        IamGrpcLauncher.class.getClassLoader().getResourceAsStream("application.json")) {
      if (null == input) {
