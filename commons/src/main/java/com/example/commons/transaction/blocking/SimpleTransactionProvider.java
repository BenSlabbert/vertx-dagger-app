 ...
 */
public class SimpleTransactionProvider implements TransactionProvider, ConnectionProvider {

  private static final Logger log = LoggerFactory.getLogger(SimpleTransactionProvider.class);

  private final ThreadLocal<Connection> connThreadLocal = new ThreadLocal<>();
  private final ThreadLocal<Boolean> txActiveThreadLocal = new ThreadLocal<>();
